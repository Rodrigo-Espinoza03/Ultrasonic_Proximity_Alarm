...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_byte_pos[2]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_2\ : label is "soft_lutpair9";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \bit_pos[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \bit_pos[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \bit_pos[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \distance[7]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ones[7]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of packet_valid_i_2 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of ready_i_1 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of rx_ready_clr_i_1 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \scratch[1]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \scratch[3]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \scratch[5]_i_3\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \scratch[6]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \scratch[6]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \scratch[7]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \scratch[7]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \tenth[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \tenth[6]_i_2\ : label is "soft_lutpair12";
begin
...
\scratch[6]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \scratch[5]_i_2_n_0\,
      I1 => \bit_pos_reg_n_0_[0]\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_MAXSONAR_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[4]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of packet_seen_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of sw_rst_i_2 : label is "soft_lutpair21";
begin
