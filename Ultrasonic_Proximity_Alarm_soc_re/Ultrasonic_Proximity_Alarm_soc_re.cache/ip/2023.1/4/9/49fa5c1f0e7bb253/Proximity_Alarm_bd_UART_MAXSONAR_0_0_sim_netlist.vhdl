...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_baudrate is
  signal accumulator : STD_LOGIC_VECTOR ( 23 downto 2 );
  ...
  signal \NLW_accumulator_reg[23]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 to 2 );
  signal \NLW_accumulator_reg[23]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_accumulator_reg[4]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 0 to 0 );
begin
...
\accumulator[16]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\accumulator[16]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\accumulator[4]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\accumulator[4]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\accumulator[8]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\accumulator[8]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\accumulator_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(1 downto 0) => accumulator(10 downto 9)
    );
...
\accumulator_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 1) => accumulator(15 downto 14),
      DI(0) => '0',
      ...
      S(3) => accumulator(16),
      S(2) => \accumulator[16]_i_2_n_0\,
      S(1) => \accumulator[16]_i_3_n_0\,
      S(0) => accumulator(13)
    );
...
\accumulator_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => accumulator(20 downto 17)
    );
...
\accumulator_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(0) => \NLW_accumulator_reg[4]_i_1_O_UNCONNECTED\(0),
      S(3) => \accumulator[4]_i_2_n_0\,
      S(2) => accumulator(3),
      S(1) => \accumulator[4]_i_3_n_0\,
      S(0) => '0'
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \scratch[6]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_byte_pos[2]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_2\ : label is "soft_lutpair6";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \bit_pos[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bit_pos[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \distance[7]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ones[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of packet_valid_i_2 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of ready_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of rx_ready_clr_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sample_count[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \sample_count[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \scratch[1]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \scratch[3]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \scratch[5]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \scratch[5]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \scratch[6]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \scratch[6]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \scratch[7]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \scratch[7]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \tenth[5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \tenth[6]_i_2\ : label is "soft_lutpair9";
begin
...
\scratch[5]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\scratch[6]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000400"
    )
        port map (
      ...
      I3 => rxclk_en,
      I4 => \FSM_sequential_current_state[1]_i_2_n_0\,
      O => \scratch[6]_i_4_n_0\
    );
\scratch[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFEF0FFF00200000"
    )
        port map (
      I0 => sync_rx2,
...
\scratch[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00008000"
    )
        port map (
