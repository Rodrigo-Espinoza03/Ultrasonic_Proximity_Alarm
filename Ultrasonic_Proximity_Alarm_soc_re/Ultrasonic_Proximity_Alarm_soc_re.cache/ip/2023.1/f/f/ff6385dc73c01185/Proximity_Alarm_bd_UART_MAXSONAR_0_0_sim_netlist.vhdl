...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal inverted_sensor_tx : STD_LOGIC;
...
sync_rx1_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => sensor_tx,
      O => inverted_sensor_tx
    );
sync_rx1_reg: unisim.vcomponents.FDSE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => inverted_sensor_tx,
      Q => sync_rx1,
      S => SR(0)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_MAXSONAR_v1_0_S00_AXI is
  ...
  signal sw_rst_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of sw_rst_i_3 : label is "soft_lutpair16";
begin
...
sw_rst_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
