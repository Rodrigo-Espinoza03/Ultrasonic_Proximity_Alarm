...
-- Date        : Mon May  4 14:21:27 2026
-- Host        : Daddy_RodrigoLT running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/ECE520_SOC/ECE520_SandBox/Ultrasonic_Proximity_Alarm_soc_re/Ultrasonic_Proximity_Alarm_soc_re.gen/sources_1/bd/Proximity_Alarm_bd/ip/Proximity_Alarm_bd_UART_MAXSONAR_0_0/Proximity_Alarm_bd_UART_MAXSONAR_0_0_sim_netlist.vhdl
...
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_baudrate is
  port (
  ...
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_baudrate : entity is "baudrate";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_baudrate;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_baudrate is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_ctrl_pmod_rx is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_ctrl_pmod_rx : entity is "ctrl_pmod_rx";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_ctrl_pmod_rx;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_ctrl_pmod_rx is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_packet_parser is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_packet_parser : entity is "packet_parser";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_packet_parser;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_packet_parser is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_receiver is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_receiver : entity is "receiver";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_receiver;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_receiver is
  ...
  signal \scratch[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \scratch[7]_i_4_n_0\ : STD_LOGIC;
  signal \scratch[7]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_byte_pos[2]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_2\ : label is "soft_lutpair13";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_current_state_reg[0]\ : label is "RX_STATE_START:01,RX_STATE_DATA:10,RX_STATE_STOP:11,RX_STATE_IDLE:00";
  attribute FSM_ENCODED_STATES of \FSM_sequential_current_state_reg[1]\ : label is "RX_STATE_START:01,RX_STATE_DATA:10,RX_STATE_STOP:11,RX_STATE_IDLE:00";
  attribute SOFT_HLUTNM of \bit_pos[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \bit_pos[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of rx_ready_clr_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \sample_count[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \sample_count[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sample_count[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \scratch[1]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \scratch[3]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \scratch[5]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \scratch[6]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \scratch[7]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \scratch[7]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \scratch[7]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \tenth[5]_i_1\ : label is "soft_lutpair15";
...
\FSM_sequential_current_state[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \bit_pos_reg_n_0_[0]\,
      I5 => \bit_pos_reg_n_0_[1]\,
...
\bit_pos[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\bit_pos[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0220"
    )
        port map (
      ...
      I1 => current_state(0),
      I2 => \bit_pos_reg_n_0_[0]\,
      I3 => \bit_pos_reg_n_0_[1]\,
      O => \bit_pos[1]_i_1_n_0\
    );
\bit_pos[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"07000800"
    )
        port map (
...
\scratch[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAFFFBAAAA0008"
        ...
        port map (
      I0 => \scratch[6]_i_2_n_0\,
      I1 => \scratch[6]_i_3_n_0\,
      I2 => \bit_pos_reg_n_0_[1]\,
      I3 => \bit_pos_reg_n_0_[2]\,
      I4 => \scratch[7]_i_4_n_0\,
...
\scratch[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\scratch[6]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\scratch[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => current_state(1),
      I1 => sync_rx2,
      I2 => \scratch[7]_i_2_n_0\,
      I3 => \scratch[7]_i_3_n_0\,
      I4 => \scratch[7]_i_4_n_0\,
      I5 => \scratch_reg_n_0_[7]\,
      O => \scratch[7]_i_1_n_0\
    );
\scratch[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\scratch[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \scratch[7]_i_5_n_0\,
      O => \scratch[7]_i_3_n_0\
    );
\scratch[7]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00040000"
    )
        port map (
      ...
      I3 => \sample_count_reg_n_0_[3]\,
      I4 => current_state(0),
      O => \scratch[7]_i_4_n_0\
    );
\scratch[7]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_uart is
  port (
    sensor_rx : out STD_LOGIC;
    packet_seen_reg : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_uart : entity is "uart";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_uart;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_uart is
  signal byte_pos : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal rxclk_en : STD_LOGIC;
begin
baudrate_inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_baudrate
     port map (
...
ctrl_pmod_rx_inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_ctrl_pmod_rx
     port map (
      SR(0) => packet_parser_inst_n_1,
      s00_axi_aclk => s00_axi_aclk,
...
packet_parser_inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_packet_parser
     port map (
...
receiver_inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_receiver
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0_S00_AXI is
  port (
    distance : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0_S00_AXI : entity is "UART_MAXSONAR_v1_0_S00_AXI";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0_S00_AXI;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of packet_seen_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \slv_reg2[0]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of sw_rst_i_2 : label is "soft_lutpair20";
begin
...
uart_inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_uart
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0 is
  port (
    distance : out STD_LOGIC_VECTOR ( 7 downto 0 );
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0 : entity is "UART_MAXSONAR_v1_0";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0 is
begin
UART_MAXSONAR_v1_0_S00_AXI_inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proximity_Alarm_bd_UART_MAXSONAR_0_0 is
  port (
    sensor_tx : in STD_LOGIC;
    distance : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sensor_rx : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of Proximity_Alarm_bd_UART_MAXSONAR_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Proximity_Alarm_bd_UART_MAXSONAR_0_0 : entity is "Proximity_Alarm_bd_UART_MAXSONAR_0_0,UART_MAXSONAR_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Proximity_Alarm_bd_UART_MAXSONAR_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of Proximity_Alarm_bd_UART_MAXSONAR_0_0 : entity is "UART_MAXSONAR_v1_0,Vivado 2023.1";
end Proximity_Alarm_bd_UART_MAXSONAR_0_0;

architecture STRUCTURE of Proximity_Alarm_bd_UART_MAXSONAR_0_0 is
...
inst: entity work.Proximity_Alarm_bd_UART_MAXSONAR_0_0_UART_MAXSONAR_v1_0
     port map (
