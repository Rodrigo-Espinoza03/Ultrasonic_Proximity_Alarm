...
HD_PWD='C:/ECE520_SOC/ECE520_SandBox/Ultrasonic_Proximity_Alarm_soc_re/Ultrasonic_Proximity_Alarm_soc_re.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Proximity_Alarm_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proximity_Alarm_bd_wrapper.tcl -notrace
