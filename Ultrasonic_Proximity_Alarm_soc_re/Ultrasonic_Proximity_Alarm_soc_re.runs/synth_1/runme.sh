...
HD_PWD='C:/ECE520_SOC/ECE520_SandBox/Ultrasonic_Proximity_Alarm_soc_re/Ultrasonic_Proximity_Alarm_soc_re.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proximity_Alarm_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proximity_Alarm_bd_wrapper.tcl
