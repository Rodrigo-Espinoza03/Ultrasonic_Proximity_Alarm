...
#set_property PACKAGE_PIN Y18 [get_ports {cs_n}] ;# JA1   CS
set_property PACKAGE_PIN L15 [get_ports {sensor_rx_0}] ;
set_property PACKAGE_PIN J16 [get_ports {sensor_tx_0}] ; 
#set_property PACKAGE_PIN Y17 [get_ports {sclk}] ;# JA4   SCK
set_property IOSTANDARD LVCMOS33 [get_ports {sensor_rx_0}]
set_property IOSTANDARD LVCMOS33 [get_ports {sensor_tx_0}]
...
set_property PACKAGE_PIN H15 [get_ports { buzzer_out_0[1] }]; #IO_L19P_T3_35 Sch=je[4]                     
...
set_property PACKAGE_PIN Y17 [get_ports { buzzer_out_0[0] }]; #IO_L7N_T1_34 Sch=je[10]                    
set_property IOSTANDARD LVCMOS33 [get_ports {buzzer_out_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {buzzer_out_0[0]}]
