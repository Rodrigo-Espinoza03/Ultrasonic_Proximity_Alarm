...
#
# Script generated by Vivado on Mon May 04 14:18:55 -0700 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Proximity_Alarm_bd.sh
...
#
# Usage        : Proximity_Alarm_bd.sh
#                Proximity_Alarm_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Proximity_Alarm_bd.sh [-reset_run]
#                Proximity_Alarm_bd.sh [-reset_log]
#                Proximity_Alarm_bd.sh [-help]
#
...
#                script (type 'Proximity_Alarm_bd.sh -help' for more information).
#
...
# script info
echo -e "Proximity_Alarm_bd.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Proximity_Alarm_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Proximity_Alarm_bd xil_defaultlib.glbl -o Proximity_Alarm_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Proximity_Alarm_bd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Proximity_Alarm_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Proximity_Alarm_bd_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Proximity_Alarm_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Proximity_Alarm_bd.sh [-help]\n\
Usage: Proximity_Alarm_bd.sh [-step]\n\
Usage: Proximity_Alarm_bd.sh [-lib_map_path]\n\
Usage: Proximity_Alarm_bd.sh [-reset_run]\n\
Usage: Proximity_Alarm_bd.sh [-reset_log]\n\
Usage: Proximity_Alarm_bd.sh [-keep_index]\n\
Usage: Proximity_Alarm_bd.sh [-noclean_files]\n\n\
